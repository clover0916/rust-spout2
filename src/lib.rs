...
pub type SpoutLibLogLevel = ffi::LibLogLevel;
...
unsafe extern "system" {
    fn GetSpout() -> *mut ffi::SPOUTLIBRARY;
}
...
impl RustySpout {
    ...
    pub fn get_sender_info<T: AsRef<str>>(
        ...
        let _lib = unsafe { library!(self.library) };

        let _sender_name = str_to_cstring!("get_sender_info", sender_name);
